import { PlainTextInput as SlackPlainTextInput, DispatchActionConfig } from '@slack/types'
import { createComponent } from '../../jsx-internals'
import { plainText } from '../composition/utils'

// TODO: Use official type when it was available in `@slack/types`
interface SlackNumberTextInput extends Omit<
  SlackPlainTextInput,
...
export const NumberTextInput = createComponent<NumberTextInputProps, SlackNumberTextInput>(
  'NumberTextInput',
  (props) => ({
    type: 'number_input',
    ...
    placeholder:
      ...
      props.placeholder ? plainText(props.placeholder, { emoji: false }) : undefined,
