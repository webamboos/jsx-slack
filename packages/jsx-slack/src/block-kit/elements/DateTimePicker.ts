...
type DatetimepickerElement = Omit<Datepicker, 'type' | 'initial_date' | 'placeholder'> & {
  type: 'datetimepicker'
 ...
 */
export const DateTimePicker: BuiltInComponent<DateTimePickerProps> = createComponent<
  DateTimePickerProps,
  DatetimepickerElement | InputBlock
>('DateTimePicker', (props) => {
  const initialDate = props.initialDateTime || props.value

  let datetime: number | undefined = typeof initialDate === 'number' ? initialDate : undefined
